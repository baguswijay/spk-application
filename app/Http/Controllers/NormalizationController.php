...
class NormalizationController extends Controller
{
    ...
    //         'criteriaweights.weight as bobot',
    ...
    //             // Mengambil semua nilai rating - bobot untuk setiap kriteria
    ...
    //             $normalisasi = $afilter[$icw]->bobot;
    //             $result = number_format($normalisasi, 1, '.');
    //             // $result = number_format($normalisasi, 2, '.', '');
    //             $afilter[$icw]->bobot = $result;
    //         }
    //     }
